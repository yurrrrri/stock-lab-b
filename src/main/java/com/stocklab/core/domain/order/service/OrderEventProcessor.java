...
public class OrderEventProcessor {
    ...
    public void process(OrderEvent event) {
        ...
        OrderEventInbox inbox = orderEventInboxService.findById(orderId).orElse(null);
        ...
        if (inbox == null) {
            inbox = orderEventInboxService.registerProcessing(orderId);
            if (inbox == null) {
                inbox = orderEventInboxService.findById(orderId)
        ...
        orderEventInboxService.markCompleted(orderId);
